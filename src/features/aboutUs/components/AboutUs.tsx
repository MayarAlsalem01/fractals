...
export default async function AboutUs() {
    ...
    return (
        <section className='w-full h-screen relative '>
            ...
            <div className='hidden md:block absolute top-0 left-0 h-full w-full overflow-hidden   perspective-distant transform-3d'>
            ...
            <div className='block md:hidden absolute top-0 left-0 h-full w-full overflow-hidden   perspective-distant transform-3d'>
