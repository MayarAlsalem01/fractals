...
export default async function AboutUs() {
    ...
    return (
        <section className='w-full h-screen relative overflow-hidden '>
            ...
            <div className=' absolute top-0 left-0 h-full w-full overflow-hidden  -z-10 perspective-distant transform-3d'>
            ...
            <div className=' h-full w-full px-4 py-4 md:px-12 flex flex-col items-center md:items-start md:justify-center gap-3'>
