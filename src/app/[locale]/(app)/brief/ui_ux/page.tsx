...
export default async function page() {
    const breifT = await db.query.brief_templates.findFirst({ where: eq(brief_templates.id, 4) })

    const sectios = await getBriefSectionsAction(4)
    return (
            ...
            <section className='min-h-screen  w-full flex flex-col items-center justify-center md:justify-start relative '>
                ...
                <div className='w-full md:w-2/3 '>
                    ...
                    <div className='md:pl-10 mt-8 md:mt-8 flex flex-col gap-4 '>
                        ...
                        <MultiStepFormWrapper sections={sectios} templateId={2} />
                    </div>
                </div>
            </section>
        </Container>
