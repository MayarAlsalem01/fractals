                    ...
                    <SidebarGroup>
                        ...
                        <SidebarGroupContent>
                            <SidebarMenu>
                                ...
                                <SidebarMenuItem >
                                    <SidebarMenuButton asChild>
                                        <Link href={'/dashboard/vacancies'} className=' bg-accent shadow  shadow-black/40'>
                                            <Grid2X2Icon />
                                            <span>Vacancies</span>
                                        </Link>
                                ...
                                <SidebarMenuItem >
                                    <SidebarMenuButton asChild>
                                        <Link href={'/dashboard/briefs-mangment'} className=' bg-accent shadow  shadow-black/40'>
                                            <Grid2X2Icon />
                                            <span>Brief Templates</span>
                                        </Link>
